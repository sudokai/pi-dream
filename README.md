...
~/.pi/agent/dream/<workspaceId>/
  ...
  runs/<runId>/                   # per dream; deleted on success, retained on failure
    ...
    trace.jsonl                   # one line per dreamer tool call (diagnostic)
